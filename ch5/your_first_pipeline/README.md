...
```bash
cmake -GNinja -DCMAKE_BUILD_TYPE=Debug -DLLVM_DIR=/home/toqiu/workspace/CLANG_BUILD/lib/cmake/llvm -Bbuild .
gdb --args ./build/your_first_pipeline input.ll
```
...
https://github.com/llvm/llvm-project/blob/main/llvm/examples/Kaleidoscope/Chapter5/toy.cpp
...
static void InitializeModuleAndManagers() {
  ...
  PB.crossRegisterProxies(*TheLAM, *TheFAM, *TheCGAM, *TheMAM); // 注意这里proxy跨层级
}
```